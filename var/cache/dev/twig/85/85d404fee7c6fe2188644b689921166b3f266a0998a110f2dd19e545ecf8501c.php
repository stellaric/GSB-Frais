...
class __TwigTemplate_bb5dd097f487be068b29cc63df3b37db5fd92f7902cfb7028cbaa4c8e662146a extends Template
{
    private $source;
    private $macros = [];
...
<br>
    <table class=\"table\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["fiche_frais"]) || array_key_exists("fiche_frais", $context) ? $context["fiche_frais"] : (function () { throw new RuntimeError('Variable "fiche_frais" does not exist.', 48, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["fiche_frai"]) {
            ...
            echo "            <tr>
                <td>";
            // line 50
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["fiche_frai"], "id", [], "any", false, false, false, 50), "html", null, true);
            echo "</td>
                <td>";
            // line 51
            ((twig_get_attribute($this->env, $this->source, $context["fiche_frai"], "mois", [], "any", false, false, false, 51)) ? (print (twig_escape_filter($this->env, twig_join_filter(twig_get_attribute($this->env, $this->source, $context["fiche_frai"], "mois", [], "any", false, false, false, 51), ", "), "html", null, true))) : (print ("")));
            echo "</td>
                <td>";
            // line 52
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["fiche_frai"], "nbJustificatifs", [], "any", false, false, false, 52), "html", null, true);
            echo "</td>
                <td>";
            // line 53
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["fiche_frai"], "montantValide", [], "any", false, false, false, 53), "html", null, true);
            echo "</td>
                <td>";
            // line 54
            ((twig_get_attribute($this->env, $this->source, $context["fiche_frai"], "dateModif", [], "any", false, false, false, 54)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["fiche_frai"], "dateModif", [], "any", false, false, false, 54), "d-m-Y"), "html", null, true))) : (print ("")));
            echo "</td>
...
";
    ...
    {
        return array (  189 => 62,  180 => 58,  171 => 54,  167 => 53,  163 => 52,  159 => 51,  155 => 50,  152 => 49,  147 => 48,  120 => 24,  116 => 23,  112 => 22,  107 => 20,  95 => 11,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
